* =============================================================================
* ROBUST FEASIBLE PENG-ROBINSON EOS COMPETITION MODEL (FIXED)
* =============================================================================
* Fixes symbolic equation redefinition and assignment errors
...
* Phase selection with unique equation names
phase_selection_1.. Z_actual('1') =e= Z_v('1');
phase_selection_2.. Z_actual('2') =e= 0.7 * Z_v('2') + 0.3 * Z_l('2');
phase_selection_3.. Z_actual('3') =e= 0.7 * Z_v('3') + 0.3 * Z_l('3');
...
FILE report /robust_pr_fixed_results.txt/;
PUT report;
PUT "ROBUST PENG-ROBINSON EOS COMPETITION RESULTS (FIXED)"/;
PUT "===================================================="/;
PUT //;
...
DISPLAY "Robust PR EOS results saved to robust_pr_fixed_results.txt";