...
EQUATIONS
    ...
    * Configuration B equations (6 states)
    pressure_high_B      'High pressure states B'
    pressure_low_B       'Low pressure states B'
    ...
    recuperator_balance      'Recuperator energy balance'
...
pressure_high_B$(config_option = 2).. P('1') =e= P('5') AND P('5') =e= P('6');
pressure_low_B$(config_option = 2).. P('2') =e= P('3') AND P('3') =e= P('4');
temperature_cycle_B$(config_option = 2).. T('4') =e= T('4');
...
recuperator_balance$(config_option = 2).. Q_recup =e= m_wf * (h('2') - h('3')) AND Q_recup =e= m_wf * (h('6') - h('5'));
